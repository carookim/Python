# # chatgpt에 pdf 파일을 넣어서 stremlit명령어를 만들어 달라고 한다.
# # 사용될 프로그램 용어 : streamlit 파이썬 판다스
...
#                     st.experimental_rerun()
#                 else:
#                     st.session_state.members.loc[len(st.session_state.members)] = {"회원아이디": name, "회원이름": customer_id}
